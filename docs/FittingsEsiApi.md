# esi_api_client.FittingsEsiApi

All URIs are relative to *https://esi.evetech.net*

Method | HTTP request | Description
------------- | ------------- | -------------
[**delete_characters_character_id_fittings_fitting_id**](FittingsEsiApi.md#delete_characters_character_id_fittings_fitting_id) | **DELETE** /characters/{character_id}/fittings/{fitting_id} | Delete fitting
[**get_characters_character_id_fittings**](FittingsEsiApi.md#get_characters_character_id_fittings) | **GET** /characters/{character_id}/fittings | Get fittings
[**post_characters_character_id_fittings**](FittingsEsiApi.md#post_characters_character_id_fittings) | **POST** /characters/{character_id}/fittings | Create fitting
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = esi_api_client.FittingsEsiApi(api_client)
    ...
    try:
        ...
        print("The response of FittingsEsiApi->delete_characters_character_id_fittings_fitting_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FittingsEsiApi->delete_characters_character_id_fittings_fitting_id: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FittingsEsiApi->get_characters_character_id_fittings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FittingsEsiApi->get_characters_character_id_fittings: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    if_none_match = 'if_none_match_example' # str | The ETag of the previous request. A 304 will be returned if this matches the current ETag. (optional)
    x_tenant = 'tranquility' # str | The tenant ID for the request. Defaults to 'tranquility'. (optional)
    post_characters_character_id_fittings_request = esi_api_client.PostCharactersCharacterIdFittingsRequest() # PostCharactersCharacterIdFittingsRequest |  (optional)
    ...
    try:
        ...
        print("The response of FittingsEsiApi->post_characters_character_id_fittings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FittingsEsiApi->post_characters_character_id_fittings: %s\n" % e)
```
