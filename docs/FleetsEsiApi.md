# esi_api_client.FleetsEsiApi

All URIs are relative to *https://esi.evetech.net*

Method | HTTP request | Description
------------- | ------------- | -------------
[**delete_fleets_fleet_id_members_member_id**](FleetsEsiApi.md#delete_fleets_fleet_id_members_member_id) | **DELETE** /fleets/{fleet_id}/members/{member_id} | Kick fleet member
[**delete_fleets_fleet_id_squads_squad_id**](FleetsEsiApi.md#delete_fleets_fleet_id_squads_squad_id) | **DELETE** /fleets/{fleet_id}/squads/{squad_id} | Delete fleet squad
[**delete_fleets_fleet_id_wings_wing_id**](FleetsEsiApi.md#delete_fleets_fleet_id_wings_wing_id) | **DELETE** /fleets/{fleet_id}/wings/{wing_id} | Delete fleet wing
[**get_characters_character_id_fleet**](FleetsEsiApi.md#get_characters_character_id_fleet) | **GET** /characters/{character_id}/fleet | Get character fleet info
[**get_fleets_fleet_id**](FleetsEsiApi.md#get_fleets_fleet_id) | **GET** /fleets/{fleet_id} | Get fleet information
[**get_fleets_fleet_id_members**](FleetsEsiApi.md#get_fleets_fleet_id_members) | **GET** /fleets/{fleet_id}/members | Get fleet members
[**get_fleets_fleet_id_wings**](FleetsEsiApi.md#get_fleets_fleet_id_wings) | **GET** /fleets/{fleet_id}/wings | Get fleet wings
[**post_fleets_fleet_id_members**](FleetsEsiApi.md#post_fleets_fleet_id_members) | **POST** /fleets/{fleet_id}/members | Create fleet invitation
[**post_fleets_fleet_id_wings**](FleetsEsiApi.md#post_fleets_fleet_id_wings) | **POST** /fleets/{fleet_id}/wings | Create fleet wing
[**post_fleets_fleet_id_wings_wing_id_squads**](FleetsEsiApi.md#post_fleets_fleet_id_wings_wing_id_squads) | **POST** /fleets/{fleet_id}/wings/{wing_id}/squads | Create fleet squad
[**put_fleets_fleet_id**](FleetsEsiApi.md#put_fleets_fleet_id) | **PUT** /fleets/{fleet_id} | Update fleet
[**put_fleets_fleet_id_members_member_id**](FleetsEsiApi.md#put_fleets_fleet_id_members_member_id) | **PUT** /fleets/{fleet_id}/members/{member_id} | Move fleet member
[**put_fleets_fleet_id_squads_squad_id**](FleetsEsiApi.md#put_fleets_fleet_id_squads_squad_id) | **PUT** /fleets/{fleet_id}/squads/{squad_id} | Rename fleet squad
[**put_fleets_fleet_id_wings_wing_id**](FleetsEsiApi.md#put_fleets_fleet_id_wings_wing_id) | **PUT** /fleets/{fleet_id}/wings/{wing_id} | Rename fleet wing
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = esi_api_client.FleetsEsiApi(api_client)
    fleet_id = 56 # int | 
    member_id = 56 # int | 
    ...
    try:
        ...
        print("The response of FleetsEsiApi->delete_fleets_fleet_id_members_member_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->delete_fleets_fleet_id_members_member_id: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FleetsEsiApi->delete_fleets_fleet_id_squads_squad_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->delete_fleets_fleet_id_squads_squad_id: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FleetsEsiApi->delete_fleets_fleet_id_wings_wing_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->delete_fleets_fleet_id_wings_wing_id: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FleetsEsiApi->get_characters_character_id_fleet:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->get_characters_character_id_fleet: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FleetsEsiApi->get_fleets_fleet_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->get_fleets_fleet_id: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FleetsEsiApi->get_fleets_fleet_id_members:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->get_fleets_fleet_id_members: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FleetsEsiApi->get_fleets_fleet_id_wings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->get_fleets_fleet_id_wings: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    if_none_match = 'if_none_match_example' # str | The ETag of the previous request. A 304 will be returned if this matches the current ETag. (optional)
    x_tenant = 'tranquility' # str | The tenant ID for the request. Defaults to 'tranquility'. (optional)
    post_fleets_fleet_id_members_request = esi_api_client.PostFleetsFleetIdMembersRequest() # PostFleetsFleetIdMembersRequest |  (optional)
    ...
    try:
        ...
        print("The response of FleetsEsiApi->post_fleets_fleet_id_members:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->post_fleets_fleet_id_members: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FleetsEsiApi->post_fleets_fleet_id_wings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->post_fleets_fleet_id_wings: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FleetsEsiApi->post_fleets_fleet_id_wings_wing_id_squads:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->post_fleets_fleet_id_wings_wing_id_squads: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    if_none_match = 'if_none_match_example' # str | The ETag of the previous request. A 304 will be returned if this matches the current ETag. (optional)
    x_tenant = 'tranquility' # str | The tenant ID for the request. Defaults to 'tranquility'. (optional)
    put_fleets_fleet_id_request = esi_api_client.PutFleetsFleetIdRequest() # PutFleetsFleetIdRequest |  (optional)
    ...
    try:
        ...
        print("The response of FleetsEsiApi->put_fleets_fleet_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->put_fleets_fleet_id: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    if_none_match = 'if_none_match_example' # str | The ETag of the previous request. A 304 will be returned if this matches the current ETag. (optional)
    x_tenant = 'tranquility' # str | The tenant ID for the request. Defaults to 'tranquility'. (optional)
    put_fleets_fleet_id_members_member_id_request = esi_api_client.PutFleetsFleetIdMembersMemberIdRequest() # PutFleetsFleetIdMembersMemberIdRequest |  (optional)
    ...
    try:
        ...
        print("The response of FleetsEsiApi->put_fleets_fleet_id_members_member_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->put_fleets_fleet_id_members_member_id: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    if_none_match = 'if_none_match_example' # str | The ETag of the previous request. A 304 will be returned if this matches the current ETag. (optional)
    x_tenant = 'tranquility' # str | The tenant ID for the request. Defaults to 'tranquility'. (optional)
    put_fleets_fleet_id_squads_squad_id_request = esi_api_client.PutFleetsFleetIdSquadsSquadIdRequest() # PutFleetsFleetIdSquadsSquadIdRequest |  (optional)
    ...
    try:
        ...
        print("The response of FleetsEsiApi->put_fleets_fleet_id_squads_squad_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->put_fleets_fleet_id_squads_squad_id: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FleetsEsiApi->put_fleets_fleet_id_wings_wing_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FleetsEsiApi->put_fleets_fleet_id_wings_wing_id: %s\n" % e)
```
