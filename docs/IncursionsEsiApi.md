# esi_api_client.IncursionsEsiApi

All URIs are relative to *https://esi.evetech.net*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_incursions**](IncursionsEsiApi.md#get_incursions) | **GET** /incursions | List incursions
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = esi_api_client.IncursionsEsiApi(api_client)
    ...
    try:
        ...
        print("The response of IncursionsEsiApi->get_incursions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IncursionsEsiApi->get_incursions: %s\n" % e)
```
