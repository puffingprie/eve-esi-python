# esi_api_client.InsuranceEsiApi

All URIs are relative to *https://esi.evetech.net*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_insurance_prices**](InsuranceEsiApi.md#get_insurance_prices) | **GET** /insurance/prices | List insurance levels
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = esi_api_client.InsuranceEsiApi(api_client)
    ...
    try:
        ...
        print("The response of InsuranceEsiApi->get_insurance_prices:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InsuranceEsiApi->get_insurance_prices: %s\n" % e)
```
