# esi_api_client.LocationEsiApi

All URIs are relative to *https://esi.evetech.net*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_characters_character_id_location**](LocationEsiApi.md#get_characters_character_id_location) | **GET** /characters/{character_id}/location | Get character location
[**get_characters_character_id_online**](LocationEsiApi.md#get_characters_character_id_online) | **GET** /characters/{character_id}/online | Get character online
[**get_characters_character_id_ship**](LocationEsiApi.md#get_characters_character_id_ship) | **GET** /characters/{character_id}/ship | Get current ship
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = esi_api_client.LocationEsiApi(api_client)
    ...
    try:
        ...
        print("The response of LocationEsiApi->get_characters_character_id_location:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationEsiApi->get_characters_character_id_location: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LocationEsiApi->get_characters_character_id_online:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationEsiApi->get_characters_character_id_online: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LocationEsiApi->get_characters_character_id_ship:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationEsiApi->get_characters_character_id_ship: %s\n" % e)
```
