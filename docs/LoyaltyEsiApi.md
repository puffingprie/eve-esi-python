# esi_api_client.LoyaltyEsiApi

All URIs are relative to *https://esi.evetech.net*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_characters_character_id_loyalty_points**](LoyaltyEsiApi.md#get_characters_character_id_loyalty_points) | **GET** /characters/{character_id}/loyalty/points | Get loyalty points
[**get_loyalty_stores_corporation_id_offers**](LoyaltyEsiApi.md#get_loyalty_stores_corporation_id_offers) | **GET** /loyalty/stores/{corporation_id}/offers | List loyalty store offers
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = esi_api_client.LoyaltyEsiApi(api_client)
    ...
    try:
        ...
        print("The response of LoyaltyEsiApi->get_characters_character_id_loyalty_points:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LoyaltyEsiApi->get_characters_character_id_loyalty_points: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LoyaltyEsiApi->get_loyalty_stores_corporation_id_offers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LoyaltyEsiApi->get_loyalty_stores_corporation_id_offers: %s\n" % e)
```
