# esi_api_client.SovereigntyEsiApi

All URIs are relative to *https://esi.evetech.net*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_sovereignty_campaigns**](SovereigntyEsiApi.md#get_sovereignty_campaigns) | **GET** /sovereignty/campaigns | List sovereignty campaigns
[**get_sovereignty_map**](SovereigntyEsiApi.md#get_sovereignty_map) | **GET** /sovereignty/map | List sovereignty of systems
[**get_sovereignty_structures**](SovereigntyEsiApi.md#get_sovereignty_structures) | **GET** /sovereignty/structures | List sovereignty structures
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = esi_api_client.SovereigntyEsiApi(api_client)
    ...
    try:
        ...
        print("The response of SovereigntyEsiApi->get_sovereignty_campaigns:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SovereigntyEsiApi->get_sovereignty_campaigns: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SovereigntyEsiApi->get_sovereignty_map:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SovereigntyEsiApi->get_sovereignty_map: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SovereigntyEsiApi->get_sovereignty_structures:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SovereigntyEsiApi->get_sovereignty_structures: %s\n" % e)
```
