# esi_api_client.WarsEsiApi

All URIs are relative to *https://esi.evetech.net*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_wars**](WarsEsiApi.md#get_wars) | **GET** /wars | List wars
[**get_wars_war_id**](WarsEsiApi.md#get_wars_war_id) | **GET** /wars/{war_id} | Get war information
[**get_wars_war_id_killmails**](WarsEsiApi.md#get_wars_war_id_killmails) | **GET** /wars/{war_id}/killmails | List kills for a war
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = esi_api_client.WarsEsiApi(api_client)
    ...
    try:
        ...
        print("The response of WarsEsiApi->get_wars:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WarsEsiApi->get_wars: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WarsEsiApi->get_wars_war_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WarsEsiApi->get_wars_war_id: %s\n" % e)
```
...
with esi_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WarsEsiApi->get_wars_war_id_killmails:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WarsEsiApi->get_wars_war_id_killmails: %s\n" % e)
```
