...
class ClonesEsiApi:
    ...
    def get_characters_character_id_clones_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CharactersCharacterIdClonesGet]:
        """Get clones
    ...
    @validate_call
    def get_characters_character_id_clones_without_preload_content(
        self,
        character_id: Annotated[StrictInt, Field(description="The ID of the character")],
        x_compatibility_date: Annotated[date, Field(description="The compatibility date for the request.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="The language to use for the response. Defaults to 'en'.")] = None,
    ...
    def _get_characters_character_id_clones_serialize(
        self,
        character_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/characters/{character_id}/clones',
    ...
    @validate_call
    def get_characters_character_id_implants_without_preload_content(
        self,
        character_id: Annotated[StrictInt, Field(description="The ID of the character")],
        x_compatibility_date: Annotated[date, Field(description="The compatibility date for the request.")],
        accept_language: Annotated[Optional[StrictStr], Field(description="The language to use for the response. Defaults to 'en'.")] = None,
    ...
    def _get_characters_character_id_implants_serialize(
        self,
        character_id,
        x_compatibility_date,
        accept_language,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/characters/{character_id}/implants',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
