...
class RoutesEsiApi:
    ...
    def get_route_origin_destination(
        ...
        avoid: Optional[Annotated[List[StrictInt], Field(max_length=100)]] = None,
        connections: Optional[Annotated[List[Annotated[List[StrictInt], Field(min_length=2, max_length=2)]], Field(max_length=100)]] = None,
