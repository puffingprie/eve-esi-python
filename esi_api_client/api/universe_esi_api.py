...
class UniverseEsiApi:
    ...
    def post_universe_ids(
        ...
        if_none_match: Annotated[Optional[StrictStr], Field(description="The ETag of the previous request. A 304 will be returned if this matches the current ETag.")] = None,
        x_tenant: Annotated[Optional[StrictStr], Field(description="The tenant ID for the request. Defaults to 'tranquility'.")] = None,
        request_body: Optional[Annotated[List[StrictStr], Field(min_length=1, max_length=500)]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def post_universe_names(
        ...
        if_none_match: Annotated[Optional[StrictStr], Field(description="The ETag of the previous request. A 304 will be returned if this matches the current ETag.")] = None,
        x_tenant: Annotated[Optional[StrictStr], Field(description="The tenant ID for the request. Defaults to 'tranquility'.")] = None,
        request_body: Optional[Annotated[List[StrictInt], Field(min_length=1, max_length=1000)]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
