...
class CharactersCharacterIdCalendarEventIdAttendeesGetInner(BaseModel):
    """
    character_id and response of an attendee
    """ # noqa: E501
    character_id: Optional[StrictInt] = None
    event_response: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["character_id", "event_response"]
    ...
    def event_response_validate_enum(cls, value):
        ...
        if value not in set(['declined', 'not_responded', 'accepted', 'tentative']):
