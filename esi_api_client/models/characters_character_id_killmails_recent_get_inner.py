...
class CharactersCharacterIdKillmailsRecentGetInner(BaseModel):
    """
    CharactersCharacterIdKillmailsRecentGetInner
    """ # noqa: E501
    killmail_hash: StrictStr = Field(description="A hash of this killmail")
    killmail_id: StrictInt = Field(description="ID of this killmail")
    __properties: ClassVar[List[str]] = ["killmail_hash", "killmail_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "killmail_hash": obj.get("killmail_hash"),
