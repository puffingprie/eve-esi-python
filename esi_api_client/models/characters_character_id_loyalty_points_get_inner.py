...
class CharactersCharacterIdLoyaltyPointsGetInner(BaseModel):
    """
    CharactersCharacterIdLoyaltyPointsGetInner
    """ # noqa: E501
    corporation_id: StrictInt
    loyalty_points: StrictInt
    __properties: ClassVar[List[str]] = ["corporation_id", "loyalty_points"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "loyalty_points": obj.get("loyalty_points")
        })
        return _obj
