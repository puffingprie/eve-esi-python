...
class CharactersCharacterIdMailListsGetInner(BaseModel):
    """
    CharactersCharacterIdMailListsGetInner
    """ # noqa: E501
    mailing_list_id: StrictInt = Field(description="Mailing list ID")
    name: StrictStr
    __properties: ClassVar[List[str]] = ["mailing_list_id", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mailing_list_id": obj.get("mailing_list_id"),
            "name": obj.get("name")
        })
        return _obj
