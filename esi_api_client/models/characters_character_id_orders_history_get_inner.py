...
class CharactersCharacterIdOrdersHistoryGetInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["duration", "escrow", "is_buy_order", "is_corporation", "issued", "location_id", "min_volume", "order_id", "price", "range", "region_id", "state", "type_id", "volume_remain", "volume_total"]
