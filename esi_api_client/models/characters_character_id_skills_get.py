...
class CharactersCharacterIdSkillsGet(BaseModel):
    ...
    """ # noqa: E501
    skills: List[CharactersCharacterIdSkillsGetSkillsInner]
    total_sp: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "skills": [CharactersCharacterIdSkillsGetSkillsInner.from_dict(_item) for _item in obj["skills"]] if obj.get("skills") is not None else None,
