...
class CorporationsCorporationIdContainersLogsGetInner(BaseModel):
    """
    ...
    new_config_bitmask: Optional[StrictInt] = None
    old_config_bitmask: Optional[StrictInt] = None
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['add', 'assemble', 'configure', 'enter_password', 'lock', 'move', 'repackage', 'set_name', 'set_password', 'unlock']):
    ...
    def password_type_validate_enum(cls, value):
        ...
        if value not in set(['config', 'general']):
