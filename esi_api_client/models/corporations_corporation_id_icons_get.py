...
class CorporationsCorporationIdIconsGet(BaseModel):
    ...
    """ # noqa: E501
    px128x128: Optional[StrictStr] = None
    px256x256: Optional[StrictStr] = None
    px64x64: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["px128x128", "px256x256", "px64x64"]
