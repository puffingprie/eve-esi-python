...
class CorporationsCorporationIdMembersTitlesGetInner(BaseModel):
    """
    CorporationsCorporationIdMembersTitlesGetInner
    """ # noqa: E501
    character_id: StrictInt
    titles: List[StrictInt] = Field(description="A list of title_id")
    __properties: ClassVar[List[str]] = ["character_id", "titles"]
