...
class CorporationsCorporationIdMembertrackingGetInner(BaseModel):
    """
    CorporationsCorporationIdMembertrackingGetInner
    """ # noqa: E501
    base_id: Optional[StrictInt] = None
    character_id: StrictInt
    location_id: Optional[StrictInt] = None
    logoff_date: Optional[datetime] = None
    logon_date: Optional[datetime] = None
    ship_type_id: Optional[StrictInt] = None
    start_date: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["base_id", "character_id", "location_id", "logoff_date", "logon_date", "ship_type_id", "start_date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "logoff_date": obj.get("logoff_date"),
            "logon_date": obj.get("logon_date"),
