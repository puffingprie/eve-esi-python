...
class CorporationsCorporationIdOrdersGetInner(BaseModel):
    """
    ...
    issued_by: StrictInt = Field(description="The character who issued this order")
    ...
    __properties: ClassVar[List[str]] = ["duration", "escrow", "is_buy_order", "issued", "issued_by", "location_id", "min_volume", "order_id", "price", "range", "region_id", "type_id", "volume_remain", "volume_total", "wallet_division"]
