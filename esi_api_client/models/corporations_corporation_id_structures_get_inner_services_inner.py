...
class CorporationsCorporationIdStructuresGetInnerServicesInner(BaseModel):
    """
    service object
    """ # noqa: E501
    name: StrictStr
    ...
    def state_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['online', 'offline', 'cleanup']):
            raise ValueError("must be one of enum values ('online', 'offline', 'cleanup')")
        return value
