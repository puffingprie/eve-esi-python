...
class FwLeaderboardsCharactersGetKills(BaseModel):
    """
    Top 100 rankings of pilots by number of kills from yesterday, last week and in total
    """ # noqa: E501
    active_total: List[FwLeaderboardsCharactersGetKillsActiveTotalInner] = Field(description="Top 100 ranking of pilots active in faction warfare by total kills. A pilot is considered \"active\" if they have participated in faction warfare in the past 14 days")
    last_week: List[FwLeaderboardsCharactersGetKillsLastWeekInner] = Field(description="Top 100 ranking of pilots by kills in the past week")
    yesterday: List[FwLeaderboardsCharactersGetKillsYesterdayInner] = Field(description="Top 100 ranking of pilots by kills in the past day")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "active_total": [FwLeaderboardsCharactersGetKillsActiveTotalInner.from_dict(_item) for _item in obj["active_total"]] if obj.get("active_total") is not None else None,
            "last_week": [FwLeaderboardsCharactersGetKillsLastWeekInner.from_dict(_item) for _item in obj["last_week"]] if obj.get("last_week") is not None else None,
            "yesterday": [FwLeaderboardsCharactersGetKillsYesterdayInner.from_dict(_item) for _item in obj["yesterday"]] if obj.get("yesterday") is not None else None
        })
        return _obj
