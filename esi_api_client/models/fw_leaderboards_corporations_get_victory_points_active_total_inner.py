...
class FwLeaderboardsCorporationsGetVictoryPointsActiveTotalInner(BaseModel):
    """
    active_total object
    """ # noqa: E501
    amount: Optional[StrictInt] = Field(default=None, description="Amount of victory points")
    corporation_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["amount", "corporation_id"]
