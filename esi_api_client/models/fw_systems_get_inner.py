...
class FwSystemsGetInner(BaseModel):
    """
    FwSystemsGetInner
    """ # noqa: E501
    contested: StrictStr
    occupier_faction_id: StrictInt
    owner_faction_id: StrictInt
    solar_system_id: StrictInt
    victory_points: StrictInt
    victory_points_threshold: StrictInt
    ...
    def contested_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['captured', 'contested', 'uncontested', 'vulnerable']):
