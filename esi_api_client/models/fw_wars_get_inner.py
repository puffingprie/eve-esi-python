...
class FwWarsGetInner(BaseModel):
    """
    FwWarsGetInner
    """ # noqa: E501
    against_id: StrictInt = Field(description="The faction ID of the enemy faction.")
    faction_id: StrictInt
    __properties: ClassVar[List[str]] = ["against_id", "faction_id"]
