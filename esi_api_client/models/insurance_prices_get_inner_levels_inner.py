...
class InsurancePricesGetInnerLevelsInner(BaseModel):
    """
    level object
    """ # noqa: E501
    cost: Union[StrictFloat, StrictInt]
    name: StrictStr = Field(description="Localized insurance level")
    payout: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["cost", "name", "payout"]
