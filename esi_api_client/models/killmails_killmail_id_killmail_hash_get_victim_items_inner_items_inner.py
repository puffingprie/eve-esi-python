...
class KillmailsKillmailIdKillmailHashGetVictimItemsInnerItemsInner(BaseModel):
    """
    item object
    """ # noqa: E501
    flag: StrictInt
    item_type_id: StrictInt
    quantity_destroyed: Optional[StrictInt] = None
    quantity_dropped: Optional[StrictInt] = None
    singleton: StrictInt
    __properties: ClassVar[List[str]] = ["flag", "item_type_id", "quantity_destroyed", "quantity_dropped", "singleton"]
