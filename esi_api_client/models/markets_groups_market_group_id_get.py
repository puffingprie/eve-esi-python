...
class MarketsGroupsMarketGroupIdGet(BaseModel):
    ...
    name: StrictStr
    parent_group_id: Optional[StrictInt] = None
    types: List[StrictInt]
    __properties: ClassVar[List[str]] = ["description", "market_group_id", "name", "parent_group_id", "types"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "parent_group_id": obj.get("parent_group_id"),
            "types": obj.get("types")
        })
        return _obj
