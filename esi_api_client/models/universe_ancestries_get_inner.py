...
class UniverseAncestriesGetInner(BaseModel):
    """
    UniverseAncestriesGetInner
    """ # noqa: E501
    bloodline_id: StrictInt = Field(description="The bloodline associated with this ancestry")
    description: StrictStr
    icon_id: Optional[StrictInt] = None
    id: StrictInt
    name: StrictStr
    short_description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["bloodline_id", "description", "icon_id", "id", "name", "short_description"]
