...
class UniverseRacesGetInner(BaseModel):
    """
    UniverseRacesGetInner
    """ # noqa: E501
    alliance_id: StrictInt = Field(description="The alliance generally associated with this race")
    description: StrictStr
    name: StrictStr
    race_id: StrictInt
    __properties: ClassVar[List[str]] = ["alliance_id", "description", "name", "race_id"]
