...
class UniverseSchematicsSchematicIdGet(BaseModel):
    ...
    """ # noqa: E501
    cycle_time: StrictInt = Field(description="Time in seconds to process a run")
    schematic_name: StrictStr
    __properties: ClassVar[List[str]] = ["cycle_time", "schematic_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schematic_name": obj.get("schematic_name")
        })
        return _obj
