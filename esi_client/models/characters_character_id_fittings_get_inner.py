...
class CharactersCharacterIdFittingsGetInner(BaseModel):
    """
    CharactersCharacterIdFittingsGetInner
    """ # noqa: E501
    description: StrictStr
    fitting_id: StrictInt
    items: List[CharactersCharacterIdFittingsGetInnerItemsInner]
    name: StrictStr
    ship_type_id: StrictInt
    __properties: ClassVar[List[str]] = ["description", "fitting_id", "items", "name", "ship_type_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fitting_id": obj.get("fitting_id"),
            "items": [CharactersCharacterIdFittingsGetInnerItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "name": obj.get("name"),
