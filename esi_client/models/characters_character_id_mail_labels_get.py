...
class CharactersCharacterIdMailLabelsGet(BaseModel):
    ...
    """ # noqa: E501
    labels: Optional[List[CharactersCharacterIdMailLabelsGetLabelsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "labels": [CharactersCharacterIdMailLabelsGetLabelsInner.from_dict(_item) for _item in obj["labels"]] if obj.get("labels") is not None else None,
