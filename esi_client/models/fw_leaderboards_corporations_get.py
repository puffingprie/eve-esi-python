...
class FwLeaderboardsCorporationsGet(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kills": FwLeaderboardsCorporationsGetKills.from_dict(obj["kills"]) if obj.get("kills") is not None else None,
            "victory_points": FwLeaderboardsCorporationsGetVictoryPoints.from_dict(obj["victory_points"]) if obj.get("victory_points") is not None else None
        })
        return _obj
