...
class InsurancePricesGetInner(BaseModel):
    """
    InsurancePricesGetInner
    """ # noqa: E501
    levels: List[InsurancePricesGetInnerLevelsInner] = Field(description="A list of a available insurance levels for this ship type")
    type_id: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "levels": [InsurancePricesGetInnerLevelsInner.from_dict(_item) for _item in obj["levels"]] if obj.get("levels") is not None else None,
