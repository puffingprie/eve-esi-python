...
class PostCharactersCharacterIdFittingsRequest(BaseModel):
    """
    PostCharactersCharacterIdFittingsRequest
    """ # noqa: E501
    description: StrictStr
    items: Annotated[List[PostCharactersCharacterIdFittingsRequestItemsInner], Field(min_length=1, max_length=512)]
    name: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [PostCharactersCharacterIdFittingsRequestItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "name": obj.get("name"),
