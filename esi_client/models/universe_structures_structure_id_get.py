...
class UniverseStructuresStructureIdGet(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The full name of the structure")
    owner_id: StrictInt = Field(description="The ID of the corporation who owns this particular structure")
    position: Optional[UniverseStructuresStructureIdGetPosition] = None
    solar_system_id: StrictInt
    type_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["name", "owner_id", "position", "solar_system_id", "type_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "position": UniverseStructuresStructureIdGetPosition.from_dict(obj["position"]) if obj.get("position") is not None else None,
