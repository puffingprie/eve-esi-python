...
class TestCharactersCharacterIdContractsGetInner(unittest.TestCase):
    """CharactersCharacterIdContractsGetInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharactersCharacterIdContractsGetInner:
        """Test CharactersCharacterIdContractsGetInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharactersCharacterIdContractsGetInner`
        """
        model = CharactersCharacterIdContractsGetInner()
        if include_optional:
    ...
    def testCharactersCharacterIdContractsGetInner(self):
        """Test CharactersCharacterIdContractsGetInner"""
