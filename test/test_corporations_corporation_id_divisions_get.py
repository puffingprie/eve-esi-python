    ...
    def make_instance(self, include_optional) -> CorporationsCorporationIdDivisionsGet:
        ...
        if include_optional:
            return CorporationsCorporationIdDivisionsGet(
                hangar = [
                    esi_api_client.models.corporations_corporation_id_divisions_get_hangar_inner.CorporationsCorporationIdDivisionsGet_hangar_inner(
                        division = 56, 
                        name = '', )
                    ],
                wallet = [
                    esi_api_client.models.corporations_corporation_id_divisions_get_wallet_inner.CorporationsCorporationIdDivisionsGet_wallet_inner(
                        division = 56, 
                        name = '', )
                    ]
            )
